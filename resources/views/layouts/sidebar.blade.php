          ...
          <div class="col-md-3 left_col">
             <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                   <a href="{{ route('admin.dashboard') }}" class="site_title"><i class="fa fa-paw mr-1"></i><span>Silica Logistics</span></a>
                </div>
                   ...
                   <div class="menu_section">
                      ...
                      <ul class="nav side-menu">
                        <li><a href="{{ route('admin.dashboard') }}"> <i class="fa fa-home"></i> Dashboard</a></li>
                         ...
                         <li>
                           <a><i class="fa fa-users"></i>Driver <span class="fa fa-chevron-down"></span></a>
                           <ul class="nav child_menu">
                              <li><a href="{{ route('driver.list') }}">List</a></li>
                              <li><a href="{{ route('driver.store') }}">Add</a></li>
                           </ul>
                        </li>
                        <li>
                           <a><i class="fa fa-truck"></i>Vehicle <span class="fa fa-chevron-down"></span></a>
                           <ul class="nav child_menu">
                              <li><a href="{{ route('vehicle.list') }}">List</a></li>
