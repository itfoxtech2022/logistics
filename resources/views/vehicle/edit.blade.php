                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <div class="">
                                 <input type="text" name="vehicle_model" value="{{ $vehicle->vehicle_model }}" required="required" class="form-control">
                                 @error('vehicle_model')
                                 <div class="error mt-0">{{$message}}</div>
                                 @enderror
                           </div>
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <div class="">
                                 <input type="text" name="vehicle_type" value="{{ $vehicle->vehicle_type }}" required="required" class="form-control">
                                 @error('vehicle_type')
                                 <div class="error mt-0">{{$message}}</div>
                                 @enderror
                           </div>
